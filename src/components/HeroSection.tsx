  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <h2 ref={desc.ref as React.RefObject<HTMLHeadingElement>} style={desc.style} className="font-accent text-xl md:text-2xl text-gold-light/80 max-w-xl mx-auto mb-8 font-normal">
